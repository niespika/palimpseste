...
export const GABARIT_CALAME = {
  ...
  "sections": [
    ...
    {
      "cle": "regle_1",
      "corps": "CITE SES MOTS. Chaque point s'ancre sur une citation du\n   squelette (« tu écris : \"...\" — ... »). Aucun reproche sans\n   citation, aucun compliment sans citation.",
      "numero": 1,
      "titre": "CITE SES MOTS",
      "verrouillee": true
    },
    ...
    {
      "cle": "regle_7",
      "corps": "LONGUEUR : 80 à 200 mots. Vocabulaire de la grille — garant,\n   articulation, attache... —, le même que dans les exercices.",
      "numero": 7,
      "titre": "LONGUEUR",
      "verrouillee": false
    },
