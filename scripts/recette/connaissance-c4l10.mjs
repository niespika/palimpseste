...
try {
  ...
  dire(ouvertes.includes('connaissance'),
    `la Connaissance est OUVERTE à la chaîne — ${ouvertes.length} au total : ${
  ...
  note(`statut de recette lu pour la Connaissance : \`${statuts.connaissance}\` — ce script n'en `
