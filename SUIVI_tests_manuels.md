...
- **Reste à Louis** : après déploiement, **relancer l'analyse de Nina** depuis le panneau. Le même défaut dort dans les autres `JSON.parse` sur du texte de modèle (orale, essai, Codex, synthèse de semestre, flashcards, questions) — non touchés, à faire sur demande.
