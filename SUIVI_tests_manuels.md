...
- [x] **C7L9-x2 — la table du `03-` §1 sur un comptage dont le seuil vaut 1 ou plus** : tranché avec Louis le 08/09 — le raté d'un comptage vaut le seuil doublé, 1 au minimum (`valeurDuVerdict`) ; `contresens_partiel` rend 4, les 47 observables se convertissent sans `n/a`. ☐ La phrase au `03-` §1 reste à écrire par Louis (fichier gelé).
