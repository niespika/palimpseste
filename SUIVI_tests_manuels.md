...
## Codex — l'épreuve à sujet libre, projetée, minutée (24/09/2026 ; `a21ee28` + `2a77539` POUSSÉS par Louis ; correctifs de la 3ᵉ revue `7effd82` commités, NON poussés ; SQL au bac à sable seulement, porte OFF)
...
- ☑ Commits `a21ee28` (le lot) et `2a77539` (le handoff du 29/08), 24/09 soir, **poussés par Louis** ; `7effd82` (3ᵉ revue) à pousser ; ☐ `codex_epreuve_minutee.sql` en PROD (le code tolère son absence, porte absente = OFF) ; ☐ push ; ☐ Louis ouvre la porte en prod (Codex → Paramètres) ; ☐ conception de l'examen du 29/09 ; ☐ assignation ; ☐ smoke prod dans la Classe Test.
