...
- ⛔ **Dommage collatéral au bac à sable, par moi** : au premier essai, mon dépôt n'avait PAS été créé (clic à côté du bouton, aucune trace serveur) et la seule ligne de la section était le dépôt de DÉCOR d'Elo — « semaine 2 · publiée », créé le 30/08 comme celui de Sacha — que j'ai supprimé en croyant supprimer le mien. La confirmation disait bien « le retour est PUBLIÉ », je ne l'ai lue qu'après. Il n'existe pas de script pour le reposer (`decor-eleve-elo.mjs` porte les compétences, pas Vestigia). Sacha garde le sien (« à valider »). Aucune donnée réelle : bac à sable seulement.
