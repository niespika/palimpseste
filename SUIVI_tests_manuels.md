...
- [ ] **C7L9-x2 — la table du `03-` §1 sur un comptage dont le seuil vaut 1 ou plus** (`synthese|contresens_partiel`, 4 clés) : le raté rend `n/a`. Condition : Louis amende la table (le seuil doublé, comme la densité — ou `seuil + 1`), ou marque `[faux]` + DETTE ; le `03-` est GELÉ, le lot ne l'a pas touché (`IDEES_post_rentree.md`, 07/09).
