...
- ☐ **Traces du smoke en PROD à retirer par Louis** (Classe Test) : ligne de plan `ba3eb7bb…` (conçue), instance `007c4f19…` (épreuve lancée), dépôt d'Élo `7554ad9e…` (`v1_remis`, photo dans le stockage, ligne de métacognition) — la chaîne peut encore écrire un retour pour ce dépôt. La session d'Élo reste ouverte dans le navigateur intégré.
