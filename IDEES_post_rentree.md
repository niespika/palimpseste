...
- **2026-09-05 — Pilotage classe · la colonne « Élève » figée (`sticky left-0 z-10`) passe PAR-DESSUS l'en-tête du site quand la page défile** (vu au smoke prod dans Chrome à 1451 px : les noms « Maëlla Pierrette, Maïlys… » se dessinent sur la barre Tableau de bord / Pilotage). Antérieur à ce lot ; l'en-tête doit porter un `z-index` supérieur à celui de la cellule figée, ou la colonne perdre son `z-10` hors du cadre du tableau.
