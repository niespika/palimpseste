  ...
  return (
    <div className="space-y-5 pb-8">
      ...
      {statut === 'DONE' && t?.retour_vf ? (
        ...
        <section className="bg-surface border border-bordure rounded-xl p-4 sm:p-5">
          <ReponsesRelancesFil eleveId={user.id} travailId={t.id} livreId={livreId} semaine={semaine} numeroSeance={numeroSeance} retour={t.retour_v1} questionsEleve={t.questions ?? []} rappelEleve={t.rappel ?? null} titres={titresRetour} fenetres={fenetres} surlignagesInitiaux={surlignagesInitiaux} />
        </section>
