// ============================================================================
// LA COPIE ANNOTÉE — un dépôt, côté professeur, DANS ALETHEIA.
...
export default async function CopieAnnoteeAletheia(
  { params, searchParams }: {
  ...
  return (
    <div className="mx-auto max-w-6xl p-4">
      <EcranCopieAnnotee vue={vue} basePassation="/prof/aletheia/passation" baseCopie="/prof/aletheia/copie" />
    </div>
  )
}
