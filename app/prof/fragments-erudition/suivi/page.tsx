  ...
  for (const c of classes) {
    ...
    const eleves: EleveStats[] = (profils ?? []).map(p => {
      ...
      return {
        ...
        inscriptionId,
        theme: t ? { theme: t.theme, description: t.description, essai_actif: t.essai_actif, propose_at: t.propose_at ?? null, valide_at: t.valide_at ?? null, commentaire_prof: t.commentaire_prof ?? null, commente_at: t.commente_at ?? null } : null,
