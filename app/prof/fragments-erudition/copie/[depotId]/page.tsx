// ============================================================================
// LA COPIE ANNOTÉE — un dépôt, côté professeur, DANS FRAGMENTS-ERUDITION.
...
export default async function CopieAnnoteeFragmentsErudition(
  { params, searchParams }: {
  ...
  return (
    <div className="mx-auto max-w-6xl p-4">
      <EcranCopieAnnotee vue={vue} basePassation="/prof/fragments-erudition/passation" baseCopie="/prof/fragments-erudition/copie" />
    </div>
  )
}
