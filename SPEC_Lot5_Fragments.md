...
La **note finale sur 20** reste **numérique** et n'existe **que** pour : **l'essai** et la **synthèse de fin de semestre** (qui **agrège fragment écrit + fragment oral**). L'**oral hebdomadaire**, comme le **fragment écrit**, **n'a PAS de /20 propre** (seulement ses sections en lettres) — le /20 lié à l'oral provient de l'**agrégation écrit + oral** produite par la synthèse de fin de semestre. *(Décision post-revue 2026-06-21 : l'oral ne porte pas de /20 individuel.)*
...
- **Orateurs :** bouton **« choisir l'orateur » seulement dans le détail d'une classe**. Le prof **fixe d'abord le nombre d'orateurs** (cette classe, cette semaine), puis **désigne** ce nombre d'élèves. *(L'oral est évalué sur ses **sections en lettres uniquement** — pas de /20 propre ; le /20 vient de l'agrégation écrit + oral en synthèse de semestre → relié à « fragment oral » côté élève, Lot 10.)*
...
- **Clic sur une épreuve →** **détail (existant)** + **« fermer le dépôt » (existant)** + **graphes** :
  ...
  - **Répartition des notes** = distribution du **/20** — **seulement** si l'épreuve porte un /20 (essai, synthèse). Pour une épreuve **sans** /20 (écrit, oral), seul le graphe **lettres** s'applique.
...
2. **Quelles épreuves portent un /20 ?** *Reco : essai, synthèse ; écrit et oral, non (le /20 lié à l'oral = agrégation écrit + oral en synthèse de semestre).*
...
- **Sections évaluées en lettres (E-A)** ; **note finale /20 chiffrée**, uniquement pour **essai / synthèse** (la synthèse agrège écrit + oral). Le fragment écrit **et l'oral** hebdo n'ont **pas** de /20 propre.
